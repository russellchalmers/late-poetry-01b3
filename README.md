...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/late-poetry-01b3)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/late-poetry-01b3
```

A live public deployment of this template is available at [https://late-poetry-01b3.templates.workers.dev](https://late-poetry-01b3.templates.workers.dev)
